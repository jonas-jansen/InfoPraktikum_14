...
public class RegexMatcherBNFATest2 {
	...
	@Test public void t02() {check(".", "1", 0, "1");}
	...
	@Test public void t47() {check("(a|abb)+b", "zzaaaabbaaabbbzz", 2, "aaaab");}
	...
	@Test public void t51() {check("(.+) \\{1}", "Look look, the cook is cooking the food food.", 35, "food food");}
	@Test public void t52() {check("((x|y)+)[ghA](ab|\\{2})*\\{1}.z", "zzxxyxAabxxxxyxzza", 2, "xxyxAabxxxxyxzz");}
	@Test public void t53() {check("a((bb)*)z\\{2}mn\\{1}t", "zzabbbbzbbmnbbbbtzz", 2, "abbbbzbbmnbbbbt");}
	@Test public void t54() {check("a((bb)*)z\\{2}mn\\{1}t", "abbbbzbbmnbbt", -1, "");}
	@Test public void t55() {check("[xyz]?(ab|c*d)+.\\{1}", "zzabddcccddcccdzz", 1, "zabddcccddcccd");}
